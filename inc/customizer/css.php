 ...
 *
 * Forked from Make v. 1.0.11
 */
class Bailey_CSS {

	/**
	 * The one instance of Bailey_CSS.
	 *
	 * @since 1.0.0.
	 *
	 * @var   Bailey_CSS    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one Bailey_CSS instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return Bailey_CSS
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `bailey_get_css->add()`. Because every property value has
...
/**
 * Return the one Bailey_CSS object.
 *
 * @since  1.0.0.
 *
 * @return Bailey_CSS    The one Bailey_CSS object.
 */
function bailey_get_css() {
	return Bailey_CSS::instance();
}
endif;
