...
if ( ! class_exists( 'Bailey_Prioritizer' ) ) :
/**
...
if ( class_exists( 'WP_Customize_Image_Control' ) && ! class_exists( 'Bailey_Customize_Image_Control' ) ) :
/**
 * Class Bailey_Customize_Image_Control
 *
 * Extend WP_Customize_Image_Control allowing access to uploads made within the same context.
 *
 * @since 1.0.0.
 */
class Bailey_Customize_Image_Control extends WP_Customize_Image_Control {
	/**
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Bailey_Customize_Misc_Control' ) ) :
/**
 ...
 * @since 1.0.0.
 */
class Bailey_Customize_Misc_Control extends WP_Customize_Control {
	/**
